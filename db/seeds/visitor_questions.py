...
VISITOR_QUESTIONS = [
    ...
    {
        "paragraph_ref": "GEN-VIS-3",
        "appendix_code": "APPENDIX_VISITOR",
        "sequence_stage": "route_specific",
        "question_text": "Do you require a visa to enter the UK as a visitor?",
        "answer_type": "boolean",
        "answer_options": None,
        "fail_condition_description": "Visa nationals must obtain entry clearance before traveling to the UK.",
        "constraint_json": {"field": "requires_visa", "operator": "exists", "value": None},
        "confidence": 0.97
    },
    {
